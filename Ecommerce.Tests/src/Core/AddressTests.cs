...
//            var address = new Address(userId, "user","user",addressLine, postalCode, country, phoneNumber);
...
//        {
//            var userId = Guid.NewGuid();
//            var address = new Address(userId,"user","user", "123 Main St", "90210", "USA", "123-456-7890");
